...
/** Settings panel for the ProductGridBlock component. */
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-2">
        <input
          ...
          onChange={(e) => setProp((p: Record<string, unknown>) => { p.showPrice = e.target.checked })}
          className="rounded"
          id="showPrice"
        />
        <label htmlFor="showPrice" className="text-xs text-gray-600">Show Prices</label>
      </div>
    </div>
  )
}
